...
SCHEME = """<scheme>
	<title>Splunk for Casper</title>
	<description>Modular input for the JAMF Software Casper JSS</description>
	...
	<endpoint>
		<args>    
			<arg name="name">
				<title>URL of the JSS</title>
				<description>The full URL of the JSS including port number.</description>
			</arg>
				   
			<arg name="username">
				<title>Username</title>
				<description>Username used to authenticate to JSS, must have API permissions.</description>
			...
			<arg name="password">
				...
				<description>Password used to authenticate to JSS.</description>
				<required_on_edit>false</required_on_edit>
				<required_on_create>true</required_on_create>
			</arg>
